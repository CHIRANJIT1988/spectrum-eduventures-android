...
public class UpdateSchoolDetails
{
	private OnTaskCompleted listener;
	private Context context;
	
	public UpdateSchoolDetails(Context context , OnTaskCompleted listener)
	{
	...
	public void execute(final String json_data, final String user_id)
	{
		...
		final String URL = context.getResources().getString(R.string.spectrumServerBaseUrl)
				+ context.getResources().getString(R.string.spectrumServerUpdateSchoolUrl);
