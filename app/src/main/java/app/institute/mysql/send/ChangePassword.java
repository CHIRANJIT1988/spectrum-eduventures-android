...
public class ChangePassword
{
	...
	public void execute(final String user_id, final String new_password)
	{
		/**
		 * Server target URL
		 */
		final String URL = context.getResources().getString(R.string.spectrumServerBaseUrl)
				+ context.getResources().getString(R.string.spectrumServerPasswordChangeUrl);
...

		{
			...
			protected Map<String, String> getParams()
			{
				...
				try
				{
					...
					params.put(JSON_TAG, Security.encrypt(new_password, prefs.getString(KEY, "")));
				}
