...
public class CountMockTestPapers
{
	private OnCountCompleted listener;
	private Context context;

	public CountMockTestPapers(Context context , OnCountCompleted listener)
	{
	...
	public void execute(final Branch branch)
	{
		...
		final String URL = context.getResources().getString(R.string.spectrumServerBaseUrl)
				+ context.getResources().getString(R.string.spectrumServerCountTestUrl);
			...
			public void onResponse(String response)
			{
				try
				{
					...
					if(jsonObj.getInt(STATUS_CODE) == 200)
					{
                         ...
                         * Successful
						 */
						listener.onCountCompleted(200, jsonObj.getInt(TOTAL), "total-mock-test");
					}
				}
